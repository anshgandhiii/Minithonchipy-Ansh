...
const SignInCard = () => {
    return (
        <div className="py-20"> {/* Reduced padding */}
            <div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto max-w-md lg:max-w-4xl"> {/* Reduced max width */}
                <div
                ...
                <div className="w-full p-8 lg:w-1/2"> {/* Reduced padding */}
                    <h2 className="text-2xl font-semibold text-gray-700 text-center">Brand</h2> {/* Reduced font size */}
                    <p className="text-xl text-gray-600 text-center">Welcome back!</p>
                    <a href="#" className="flex items-center justify-center mt-5 text-white rounded-lg shadow-md hover:bg-gray-100">
                        <div className="px-4 py-3">
                            <svg className="h-7 w-7" viewBox="0 0 40 40"> {/* Reduced icon size */}
                                <path
                    ...
                    <div className="mt-8"> {/* Reduced margin */}
